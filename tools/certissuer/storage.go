...
type Storage interface {
	...
	SaveResource(*certificate.Resource) error
	ReadResource(string) (certificate.Resource, error)
	GetFileName(string, string) (string, error)
	ReadFile(string, string) ([]byte, error)
	WriteFile(string, string, []byte) error
	WriteCertificateFiles(string, *certificate.Resource) error
	WritePFXFile(string, *certificate.Resource) error
}
...
func (s *storage) ReadFile(domain string, extension string) ([]byte, error) {
...
func (s *storage) WriteFile(domain string, extension string, data []byte) error {
